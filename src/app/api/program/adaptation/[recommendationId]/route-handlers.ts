...
import { AdaptiveCoachingError } from '@/server/services/adaptive-coaching';
...
export function createProgramAdaptationConfirmPostHandler(deps: ProgramAdaptationConfirmRouteDeps) {
  return async function POST(request: Request, context: RecommendationRouteContext): Promise<Response> {
